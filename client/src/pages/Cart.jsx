...
const Cart = () => {
  ...
  const makeOnlinePayment = async (amountInRupees) => {
  try {
    const res = await axios.post('/api/order/online', {
    ...
    const options = {
      ...
      handler: async function (response) {
        const verifyRes = await axios.post('/api/order/verify', response);
